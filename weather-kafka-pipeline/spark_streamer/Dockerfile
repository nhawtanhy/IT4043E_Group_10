...
# ----------- FIX MISSING DEPENDENCY (critical) ----------
# KafkaDataConsumer requires commons-pool2
RUN curl -L -o /opt/spark/jars/commons-pool2-2.11.1.jar \
    https://repo1.maven.org/maven2/org/apache/commons/commons-pool2/2.11.1/commons-pool2-2.11.1.jar

# ----------- Add Elasticsearch Connector (critical) ----------
...
CMD ["spark-submit", "--master", "local[*]", "/app/spark_stream.py"]